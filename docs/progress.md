...
> 마지막 업데이트: 2026-09-20 · 프로젝트: SDVC 웹서비스 Codex 전환 · 현재 단계: Implement Phase 4 · 세션 상태: T018 RED 완료, T019 GREEN 준비
...
- [ ] T019 관리자 전용 수강생 목록·검색·상세·집계 API를 구현해 T018 집계 RED를 GREEN으로 만든다.
